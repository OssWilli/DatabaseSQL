...
<html>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="insert into kelas (id_kelas,Kelas,Nip) values
		('$id_kelas','$Kelas','$Nip')";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        <div class="form-group">
            ...
            <input type="text" name="id_kelas" class="form-control" placeholder="Masukan ID_Kelas" required />
        </div>
        <div class="form-group">
            <label>Kelas:</label>
        ...
        <div class="form-group">
            <label>Nip:</label>
            <textarea name="Nip" class="form-control"placeholder="Masukan Nip" required></textarea>
        </div>
