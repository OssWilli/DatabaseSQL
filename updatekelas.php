...
<html>
    ...
    <div class="form-group">
            ...
            <input type="text" name="id_kelas" class="form-control" value =  "<?php echo $data['id_kelas']; ?>" placeholder="Masukan ID_Kelas" required />
        </div>
        <div class="form-group">
            <label>Kelas:</label>
            <input type="text" name="Kelas" class="form-control" value =  "<?php echo $data['Kelas']; ?>" placeholder="Masukan Kelas" required/>
        </div>
        <div class="form-group">
            <label>Nip:</label>
